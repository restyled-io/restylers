...
| [perltidy](#perltidy) | Perl | `v20250214.03` | Yes |
| [pg_format](#pg_format) | PSQL | `v5.3` | Yes |
| [php-cs-fixer](#php-cs-fixer) | PHP | `v3.71.0` | Yes |
...
| [rubocop](#rubocop) | Ruby | `v1.74.0` | No |
...
- perltidy:
    ...
    - perltidy
    - -st
    image: public.ecr.aws/restyled-io/restyler-perltidy:v20250214.03
    include:
    - '**/*.pl'
    - '**/*.pm'
    interpreters: []
...
- php-cs-fixer:
    ...
    - php-cs-fixer
    - fix
    image: public.ecr.aws/restyled-io/restyler-php-cs-fixer:v3.71.0
    include:
    - '**/*.php'
    interpreters: []
...
- rubocop:
    ...
    - --fail-level
    - fatal
    image: public.ecr.aws/restyled-io/restyler-rubocop:v1.74.0
    include:
    - '**/*.rb'
    interpreters:
    - ruby
...
- standardrb:
    ...
    - standardrb
    - --fix
    image: public.ecr.aws/restyled-io/restyler-standardrb:v1.47.0
    include:
    - '**/*.rb'
    interpreters:
    - ruby
...
- verible:
    ...
    - --inplace
    image: public.ecr.aws/restyled-io/restyler-verible:v0.0-3946-g851d3ff4
    include:
    - '**/*.sv'
    interpreters: []
