...
| [black](#black) | Python | `v25.9.0` | Yes |
...
| [npm-groovy-lint](#npm-groovy-lint) | Groovy | `v15.2.2` | Yes |
| [ocamlformat](#ocamlformat) | OCaml | `v0.26.2` | Yes |
| [ormolu](#ormolu) | Haskell | `v0.5.3.0` | No |
| [perltidy](#perltidy) | Perl | `v20250912` | Yes |
| [pg_format](#pg_format) | PSQL | `v5.8` | Yes |
| [php-cs-fixer](#php-cs-fixer) | PHP | `v3.88.2` | Yes |
...
- black:
    ...
    command:
    - black
    image: public.ecr.aws/restyled-io/restyler-black:v25.9.0
    include:
    - '**/*.py'
    interpreters:
    - python
...
- isort:
    ...
    command:
    - isort
    image: public.ecr.aws/restyled-io/restyler-isort:v6.1.0
    include:
    - '**/*.py'
    interpreters:
    - python
...
- npm-groovy-lint:
    ...
    - npm-groovy-lint
    - --fix
    image: public.ecr.aws/restyled-io/restyler-npm-groovy-lint:v15.2.2
    include:
    - '**/*.groovy'
    interpreters: []
...
- perltidy:
    ...
    - perltidy
    - -st
    image: public.ecr.aws/restyled-io/restyler-perltidy:v20250912
    include:
    - '**/*.pl'
    - '**/*.pm'
    interpreters: []
...
- php-cs-fixer:
    ...
    - php-cs-fixer
    - fix
    image: public.ecr.aws/restyled-io/restyler-php-cs-fixer:v3.88.2
    include:
    - '**/*.php'
    interpreters: []
...
- rubocop:
    ...
    - --fail-level
    - fatal
    image: public.ecr.aws/restyled-io/restyler-rubocop:v1.80.2
    include:
    - '**/*.rb'
    interpreters:
    - ruby
