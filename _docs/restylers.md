...
| [php-cs-fixer](#php-cs-fixer) | PHP | `v3.95.3` | Yes |
...
| [rubocop](#rubocop) | Ruby | `v1.86.1` | No |
...
| [terraform](#terraform) | Terraform | `v1.15.5` | Yes |
...
- php-cs-fixer:
    ...
    - fix
    - --no-interaction
    image: public.ecr.aws/restyled-io/restyler-php-cs-fixer:v3.95.3
    include:
    - '**/*.php'
    interpreters: []
...
- rubocop:
    ...
    - --fail-level
    - fatal
    image: public.ecr.aws/restyled-io/restyler-rubocop:v1.86.1
    include:
    - '**/*.rb'
    interpreters:
    - ruby
...
- terraform:
    ...
    - terraform
    - fmt
    image: public.ecr.aws/restyled-io/restyler-terraform:v1.15.5
    include:
    - '**/*.tf'
    interpreters: []
