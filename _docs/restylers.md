...
| [npm-groovy-lint](#npm-groovy-lint) | Groovy | `v17.0.5` | Yes |
...
| [terraform](#terraform) | Terraform | `v1.15.2` | Yes |
...
- npm-groovy-lint:
    ...
    - npm-groovy-lint
    - --fix
    image: public.ecr.aws/restyled-io/restyler-npm-groovy-lint:v17.0.5
    include:
    - '**/*.groovy'
    interpreters: []
...
- terraform:
    ...
    - terraform
    - fmt
    image: public.ecr.aws/restyled-io/restyler-terraform:v1.15.2
    include:
    - '**/*.tf'
    interpreters: []
