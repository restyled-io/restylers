...
| [npm-groovy-lint](#npm-groovy-lint) | Groovy | `v16.1.1` | Yes |
...
| [php-cs-fixer](#php-cs-fixer) | PHP | `v3.92.3` | Yes |
...
- npm-groovy-lint:
    ...
    - npm-groovy-lint
    - --fix
    image: public.ecr.aws/restyled-io/restyler-npm-groovy-lint:v16.1.1
    include:
    - '**/*.groovy'
    interpreters: []
...
- php-cs-fixer:
    ...
    - fix
    - --no-interaction
    image: public.ecr.aws/restyled-io/restyler-php-cs-fixer:v3.92.3
    include:
    - '**/*.php'
    interpreters: []
