...
| [rubocop](#rubocop) | Ruby | `v1.73.0` | No |
...
| [standardrb](#standardrb) | Ruby | `v1.45.0` | Yes |
...
- rubocop:
    ...
    - --fail-level
    - fatal
    image: public.ecr.aws/restyled-io/restyler-rubocop:v1.73.0
    include:
    - '**/*.rb'
    interpreters:
    - ruby
...
- standardrb:
    ...
    - standardrb
    - --fix
    image: public.ecr.aws/restyled-io/restyler-standardrb:v1.45.0
    include:
    - '**/*.rb'
    interpreters:
    - ruby
