...
| [npm-groovy-lint](#npm-groovy-lint) | Groovy | `v17.0.2` | Yes |
...
| [php-cs-fixer](#php-cs-fixer) | PHP | `v3.94.2` | Yes |
| [prettier](#prettier) | JavaScript | `v3.8.1-4` | Yes |
| [prettier-json](#prettier-json) | JSON | `v3.8.1-4` | Yes |
| [prettier-markdown](#prettier-markdown) | Markdown | `v3.8.1-4` | Yes |
| [prettier-ruby](#prettier-ruby) | Ruby | `v3.2.2-1` | No |
| [prettier-yaml](#prettier-yaml) | Yaml | `v3.8.1-4` | Yes |
...
| [rubocop](#rubocop) | Ruby | `v1.86.0` | No |
...
| [standardrb](#standardrb) | Ruby | `v1.54.0` | Yes |
| [stylish-haskell](#stylish-haskell) | Haskell | `v0.14.3.0` | Yes |
| [taplo](#taplo) | TOML | `0.9.3` | Yes |
| [terraform](#terraform) | Terraform | `v1.14.8` | Yes |
| [verible](#verible) | System Verilog | `v0.0-4053-g89d4d98a` | Yes |
...
- dart-format:
    ...
    - dart
    - format
    image: public.ecr.aws/restyled-io/restyler-dart-format:v3.1.4
    include:
    - '**/*.dart'
    interpreters: []
...
- fourmolu:
    ...
    - --mode
    - inplace
    image: public.ecr.aws/restyled-io/restyler-fourmolu:v0.19.0.1
    include:
    - '**/*.hs'
    interpreters: []
...
- npm-groovy-lint:
    ...
    - npm-groovy-lint
    - --fix
    image: public.ecr.aws/restyled-io/restyler-npm-groovy-lint:v17.0.2
    include:
    - '**/*.groovy'
    interpreters: []
...
- perltidy:
    ...
    - perltidy
    - -st
    image: public.ecr.aws/restyled-io/restyler-perltidy:v20250912.01
    include:
    - '**/*.pl'
    - '**/*.pm'
    interpreters: []
...
- pg_format:
    ...
    - pg_format
    - --inplace
    image: public.ecr.aws/restyled-io/restyler-pg_format:v5.8
    include:
    - '**/*.sql'
    interpreters: []
...
- php-cs-fixer:
    ...
    - fix
    - --no-interaction
    image: public.ecr.aws/restyled-io/restyler-php-cs-fixer:v3.94.2
    include:
    - '**/*.php'
    interpreters: []
...
- prettier:
    ...
    - prettier
    - --write
    image: public.ecr.aws/restyled-io/restyler-prettier:v3.8.1-4
    include:
    - '**/*.js'
    - '**/*.jsx'
    interpreters: []
...
- prettier-ruby:
    ...
    - rbprettier
    - --write
    image: public.ecr.aws/restyled-io/restyler-prettier-ruby:v3.2.2-1
    include:
    - '**/*.rb'
    interpreters:
    - ruby
...
- rubocop:
    ...
    - --fail-level
    - fatal
    image: public.ecr.aws/restyled-io/restyler-rubocop:v1.86.0
    include:
    - '**/*.rb'
    interpreters:
    - ruby
...
- scalafmt:
    ...
    - scalafmt
    - --non-interactive
    image: public.ecr.aws/restyled-io/restyler-scalafmt:v3.7.10
    include:
    - '**/*.scala'
    interpreters: []
...
- shfmt:
    ...
    - shfmt
    - -w
    image: public.ecr.aws/restyled-io/restyler-shfmt:v3.12.0
    include:
    - '**/*.sh'
    - '**/*.bash'
    interpreters:
...
- standardrb:
    ...
    - standardrb
    - --fix
    image: public.ecr.aws/restyled-io/restyler-standardrb:v1.54.0
    include:
    - '**/*.rb'
    interpreters:
    - ruby
...
- terraform:
    ...
    - terraform
    - fmt
    image: public.ecr.aws/restyled-io/restyler-terraform:v1.14.8
    include:
    - '**/*.tf'
    interpreters: []
...
- verible:
    ...
    - --inplace
    image: public.ecr.aws/restyled-io/restyler-verible:v0.0-4053-g89d4d98a
    include:
    - '**/*.sv'
    interpreters: []
