...
| [rubocop](#rubocop) | Ruby | `v1.88.2` | No |
...
- php-cs-fixer:
    ...
    - fix
    - --no-interaction
    image: public.ecr.aws/restyled-io/restyler-php-cs-fixer:v3.95.13
    include:
    - '**/*.php'
    interpreters: []
...
- rubocop:
    ...
    - --fail-level
    - fatal
    image: public.ecr.aws/restyled-io/restyler-rubocop:v1.88.2
    include:
    - '**/*.rb'
    interpreters:
    - ruby
