...
| [dart-format](#dart-format) | Dart | `v3.1.6` | Yes |
...
| [npm-groovy-lint](#npm-groovy-lint) | Groovy | `v18.0.0` | Yes |
...
| [php-cs-fixer](#php-cs-fixer) | PHP | `v3.95.11` | Yes |
| [prettier](#prettier) | JavaScript | `v3.9.4-4` | Yes |
| [prettier-json](#prettier-json) | JSON | `v3.9.4-4` | Yes |
| [prettier-markdown](#prettier-markdown) | Markdown | `v3.9.4-4` | Yes |
| [prettier-ruby](#prettier-ruby) | Ruby | `v3.2.2-1` | No |
| [prettier-yaml](#prettier-yaml) | Yaml | `v3.9.4-4` | Yes |
...
| [standardrb](#standardrb) | Ruby | `v1.55.0` | Yes |
| [stylish-haskell](#stylish-haskell) | Haskell | `v0.14.3.0` | Yes |
| [taplo](#taplo) | TOML | `0.9.3` | Yes |
| [terraform](#terraform) | Terraform | `v1.15.7` | Yes |
| [verible](#verible) | System Verilog | `v0.0-4080-ga0a8d8eb` | Yes |
...
- black:
    ...
    command:
    - black
    image: public.ecr.aws/restyled-io/restyler-black:v26.5.1
    include:
    - '**/*.py'
    interpreters:
    - python
...
- dart-format:
    ...
    - dart
    - format
    image: public.ecr.aws/restyled-io/restyler-dart-format:v3.1.6
    include:
    - '**/*.dart'
    interpreters: []
...
- npm-groovy-lint:
    ...
    - npm-groovy-lint
    - --fix
    image: public.ecr.aws/restyled-io/restyler-npm-groovy-lint:v18.0.0
    include:
    - '**/*.groovy'
    interpreters: []
...
- php-cs-fixer:
    ...
    - fix
    - --no-interaction
    image: public.ecr.aws/restyled-io/restyler-php-cs-fixer:v3.95.11
    include:
    - '**/*.php'
    interpreters: []
...
- prettier:
    ...
    - prettier
    - --write
    image: public.ecr.aws/restyled-io/restyler-prettier:v3.9.4-4
    include:
    - '**/*.js'
    - '**/*.jsx'
    interpreters: []
...
- rubocop:
    ...
    - --fail-level
    - fatal
    image: public.ecr.aws/restyled-io/restyler-rubocop:v1.88.0
    include:
    - '**/*.rb'
    interpreters:
    - ruby
...
- standardrb:
    ...
    - standardrb
    - --fix
    image: public.ecr.aws/restyled-io/restyler-standardrb:v1.55.0
    include:
    - '**/*.rb'
    interpreters:
    - ruby
...
- terraform:
    ...
    - terraform
    - fmt
    image: public.ecr.aws/restyled-io/restyler-terraform:v1.15.7
    include:
    - '**/*.tf'
    interpreters: []
...
- verible:
    ...
    - --inplace
    image: public.ecr.aws/restyled-io/restyler-verible:v0.0-4080-ga0a8d8eb
    include:
    - '**/*.sv'
    interpreters: []
