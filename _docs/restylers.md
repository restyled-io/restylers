...
| [php-cs-fixer](#php-cs-fixer) | PHP | `v3.91.3` | Yes |
| [prettier](#prettier) | JavaScript | `v3.7.4-4` | Yes |
| [prettier-json](#prettier-json) | JSON | `v3.7.4-4` | Yes |
| [prettier-markdown](#prettier-markdown) | Markdown | `v3.7.4-4` | Yes |
| [prettier-ruby](#prettier-ruby) | Ruby | `v3.2.2-1` | No |
| [prettier-yaml](#prettier-yaml) | Yaml | `v3.7.4-4` | Yes |
...
| [rubocop](#rubocop) | Ruby | `v1.81.7` | No |
...
| [sqlformat](#sqlformat) | SQL, PSQL | `0.5.4` | No |
...
| [verible](#verible) | System Verilog | `v0.0-4027-g3689529e` | Yes |
...
- php-cs-fixer:
    ...
    - fix
    - --no-interaction
    image: public.ecr.aws/restyled-io/restyler-php-cs-fixer:v3.91.3
    include:
    - '**/*.php'
    interpreters: []
...
- prettier:
    ...
    - prettier
    - --write
    image: public.ecr.aws/restyled-io/restyler-prettier:v3.7.4-4
    include:
    - '**/*.js'
    - '**/*.jsx'
    interpreters: []
...
- rubocop:
    ...
    - --fail-level
    - fatal
    image: public.ecr.aws/restyled-io/restyler-rubocop:v1.81.7
    include:
    - '**/*.rb'
    interpreters:
    - ruby
...
- sqlformat:
    ...
    - --reindent
    - --keywords=upper
    image: public.ecr.aws/restyled-io/restyler-sqlformat:0.5.4
    include:
    - '**/*.sql'
    interpreters: []
...
- verible:
    ...
    - --inplace
    image: public.ecr.aws/restyled-io/restyler-verible:v0.0-4027-g3689529e
    include:
    - '**/*.sv'
    interpreters: []
