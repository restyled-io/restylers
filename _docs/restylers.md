...
| [dart-format](#dart-format) | Dart | `v2.3.8` | Yes |
...
| [php-cs-fixer](#php-cs-fixer) | PHP | `v3.69.1` | Yes |
| [prettier](#prettier) | JavaScript | `v3.5.2-3` | Yes |
| [prettier-json](#prettier-json) | JSON | `v3.5.2-3` | Yes |
| [prettier-markdown](#prettier-markdown) | Markdown | `v3.5.2-3` | Yes |
| [prettier-ruby](#prettier-ruby) | Ruby | `v3.2.2-1` | No |
| [prettier-yaml](#prettier-yaml) | Yaml | `v3.5.2-3` | Yes |
...
| [rubocop](#rubocop) | Ruby | `v1.72.1` | No |
...
- php-cs-fixer:
    ...
    - php-cs-fixer
    - fix
    image: public.ecr.aws/restyled-io/restyler-php-cs-fixer:v3.69.1
    include:
    - '**/*.php'
    interpreters: []
...
- prettier:
    ...
    - prettier
    - --write
    image: public.ecr.aws/restyled-io/restyler-prettier:v3.5.2-3
    include:
    - '**/*.js'
    - '**/*.jsx'
    interpreters: []
...
- rubocop:
    ...
    - --fail-level
    - fatal
    image: public.ecr.aws/restyled-io/restyler-rubocop:v1.72.1
    include:
    - '**/*.rb'
    interpreters:
    - ruby
