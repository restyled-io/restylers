...
| [npm-groovy-lint](#npm-groovy-lint) | Groovy | `v15.2.0` | Yes |
| [ocamlformat](#ocamlformat) | OCaml | `v0.26.2` | Yes |
| [ormolu](#ormolu) | Haskell | `v0.5.3.0` | No |
| [perltidy](#perltidy) | Perl | `v20250311.04` | Yes |
| [pg_format](#pg_format) | PSQL | `v5.6` | Yes |
| [php-cs-fixer](#php-cs-fixer) | PHP | `v3.75.0` | Yes |
| [prettier](#prettier) | JavaScript | `v3.5.3-3` | Yes |
| [prettier-json](#prettier-json) | JSON | `v3.5.3-3` | Yes |
| [prettier-markdown](#prettier-markdown) | Markdown | `v3.5.3-3` | Yes |
| [prettier-ruby](#prettier-ruby) | Ruby | `v3.2.2-1` | No |
| [prettier-yaml](#prettier-yaml) | Yaml | `v3.5.3-3` | Yes |
| [purty](#purty) | PureScript | `v7.0.0` | Yes |
| [pyment](#pyment) | Python | `v0.3.3` | Yes |
| [refmt](#refmt) | Reason | `v3.3.3` | Yes |
| [reorder-python-imports](#reorder-python-imports) | Python | `v3.14.0` | Yes |
| [rubocop](#rubocop) | Ruby | `v1.75.6` | No |
...
| [verible](#verible) | System Verilog | `v0.0-3997-gd6924079` | Yes |
...
- npm-groovy-lint:
    ...
    - npm-groovy-lint
    - --fix
    image: public.ecr.aws/restyled-io/restyler-npm-groovy-lint:v15.2.0
    include:
    - '**/*.groovy'
    interpreters: []
...
- perltidy:
    ...
    - perltidy
    - -st
    image: public.ecr.aws/restyled-io/restyler-perltidy:v20250311.04
    include:
    - '**/*.pl'
    - '**/*.pm'
    interpreters: []
...
- php-cs-fixer:
    ...
    - php-cs-fixer
    - fix
    image: public.ecr.aws/restyled-io/restyler-php-cs-fixer:v3.75.0
    include:
    - '**/*.php'
    interpreters: []
...
- prettier:
    ...
    - prettier
    - --write
    image: public.ecr.aws/restyled-io/restyler-prettier:v3.5.3-3
    include:
    - '**/*.js'
    - '**/*.jsx'
    interpreters: []
...
- rubocop:
    ...
    - --fail-level
    - fatal
    image: public.ecr.aws/restyled-io/restyler-rubocop:v1.75.6
    include:
    - '**/*.rb'
    interpreters:
    - ruby
...
- verible:
    ...
    - --inplace
    image: public.ecr.aws/restyled-io/restyler-verible:v0.0-3997-gd6924079
    include:
    - '**/*.sv'
    interpreters: []
