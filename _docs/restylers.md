...
| [perltidy](#perltidy) | Perl | `v20250311.07` | Yes |
...
| [rubocop](#rubocop) | Ruby | `v1.76.0` | No |
...
| [verible](#verible) | System Verilog | `v0.0-4005-gfb69b42d` | Yes |
...
- perltidy:
    ...
    - perltidy
    - -st
    image: public.ecr.aws/restyled-io/restyler-perltidy:v20250311.07
    include:
    - '**/*.pl'
    - '**/*.pm'
    interpreters: []
...
- rubocop:
    ...
    - --fail-level
    - fatal
    image: public.ecr.aws/restyled-io/restyler-rubocop:v1.76.0
    include:
    - '**/*.rb'
    interpreters:
    - ruby
...
- verible:
    ...
    - --inplace
    image: public.ecr.aws/restyled-io/restyler-verible:v0.0-4005-gfb69b42d
    include:
    - '**/*.sv'
    interpreters: []
