...
| [fourmolu](#fourmolu) | Haskell | `v0.19.0.0` | No |
| [gn](#gn) | GN | `v2` | Yes |
...
| [php-cs-fixer](#php-cs-fixer) | PHP | `v3.87.2` | Yes |
...
- fourmolu:
    ...
    - --mode
    - inplace
    image: public.ecr.aws/restyled-io/restyler-fourmolu:v0.19.0.0
    include:
    - '**/*.hs'
    interpreters: []
...
- php-cs-fixer:
    ...
    - php-cs-fixer
    - fix
    image: public.ecr.aws/restyled-io/restyler-php-cs-fixer:v3.87.2
    include:
    - '**/*.php'
    interpreters: []
