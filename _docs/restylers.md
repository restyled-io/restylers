...
| [php-cs-fixer](#php-cs-fixer) | PHP | `v3.95.2` | Yes |
...
| [terraform](#terraform) | Terraform | `v1.15.4` | Yes |
...
- php-cs-fixer:
    ...
    - fix
    - --no-interaction
    image: public.ecr.aws/restyled-io/restyler-php-cs-fixer:v3.95.2
    include:
    - '**/*.php'
    interpreters: []
...
- terraform:
    ...
    - terraform
    - fmt
    image: public.ecr.aws/restyled-io/restyler-terraform:v1.15.4
    include:
    - '**/*.tf'
    interpreters: []
