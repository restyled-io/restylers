...
| [verible](#verible) | System Verilog | `v0.0-4296-g0f262651` | Yes |
...
- php-cs-fixer:
    ...
    - fix
    - --no-interaction
    image: public.ecr.aws/restyled-io/restyler-php-cs-fixer:v3.95.27
    include:
    - '**/*.php'
    interpreters: []
...
- verible:
    ...
    - --inplace
    image: public.ecr.aws/restyled-io/restyler-verible:v0.0-4296-g0f262651
    include:
    - '**/*.sv'
    interpreters: []
