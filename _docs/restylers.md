...
| [php-cs-fixer](#php-cs-fixer) | PHP | `v3.87.0` | Yes |
...
| [rubocop](#rubocop) | Ruby | `v1.80.0` | No |
...
- perltidy:
    ...
    - perltidy
    - -st
    image: public.ecr.aws/restyled-io/restyler-perltidy:v20250711
    include:
    - '**/*.pl'
    - '**/*.pm'
    interpreters: []
...
- php-cs-fixer:
    ...
    - php-cs-fixer
    - fix
    image: public.ecr.aws/restyled-io/restyler-php-cs-fixer:v3.87.0
    include:
    - '**/*.php'
    interpreters: []
...
- rubocop:
    ...
    - --fail-level
    - fatal
    image: public.ecr.aws/restyled-io/restyler-rubocop:v1.80.0
    include:
    - '**/*.rb'
    interpreters:
    - ruby
