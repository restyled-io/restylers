...
| [prettier](#prettier) | JavaScript | `v3.9.3-4` | Yes |
| [prettier-json](#prettier-json) | JSON | `v3.9.3-4` | Yes |
| [prettier-markdown](#prettier-markdown) | Markdown | `v3.9.3-4` | Yes |
| [prettier-ruby](#prettier-ruby) | Ruby | `v3.2.2-1` | No |
| [prettier-yaml](#prettier-yaml) | Yaml | `v3.9.3-4` | Yes |
...
- prettier:
    ...
    - prettier
    - --write
    image: public.ecr.aws/restyled-io/restyler-prettier:v3.9.3-4
    include:
    - '**/*.js'
    - '**/*.jsx'
    interpreters: []
