...
| [php-cs-fixer](#php-cs-fixer) | PHP | `v3.83.0` | Yes |
...
| [verible](#verible) | System Verilog | `v0.0-4011-g03c61290` | Yes |
...
- php-cs-fixer:
    ...
    - php-cs-fixer
    - fix
    image: public.ecr.aws/restyled-io/restyler-php-cs-fixer:v3.83.0
    include:
    - '**/*.php'
    interpreters: []
...
- rubocop:
    ...
    - --fail-level
    - fatal
    image: public.ecr.aws/restyled-io/restyler-rubocop:v1.78.0
    include:
    - '**/*.rb'
    interpreters:
    - ruby
...
- verible:
    ...
    - --inplace
    image: public.ecr.aws/restyled-io/restyler-verible:v0.0-4011-g03c61290
    include:
    - '**/*.sv'
    interpreters: []
